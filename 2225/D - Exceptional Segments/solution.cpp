...
 
    // left side
    int fourkplus1_count = (x + 2) / 4;
    int fourkplus3_count = (x  + 4) / 4;
    // fourkplus3_count++;
 
    debug(fourkplus1_count, fourkplus3_count);
 
    int rightplus1, rightplus3;
    if(x % 4 == 0)
    {
        rightplus1 = (n - x + 3)/4;
        rightplus3 = (n - x + 1) / 4;
...
 
    int MOD = 998244353;
    fourkplus1_count %= MOD;
    fourkplus3_count %= MOD;
    rightplus1 %= MOD;
    rightplus3 %= MOD;
 
    cout << (((fourkplus1_count * rightplus1) % MOD) + ((fourkplus3_count * rightplus3) % MOD)) % MOD << endl;
