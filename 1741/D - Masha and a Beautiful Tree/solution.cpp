...
 
int fn(int l, int r, vector<int>& tree)
{
    // debug(l, r);
    if(l == r)
    {
...
 
    int mid = l + (r - l)/ 2;
    int resleft = fn(l, mid, tree);
    int resright = fn(mid + 1, r, tree);
 
    if(resleft == -1 || resright == -1)
    return -1;
    // debug(resleft, resright, l, r);
    
    if(tree[l] == tree[mid + 1] - (r - l + 1) /2 )
    {
        return resleft+ resright;
    }
    else if(tree[l] == tree[mid + 1] + (r - l + 1) /2 )
    {
        swap(tree[l], tree[mid + 1]);
        return 1 + resleft+ resright;
    }
    else
    {
        // debug(resleft, l, r);
