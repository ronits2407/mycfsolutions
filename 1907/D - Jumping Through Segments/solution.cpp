...
 
    ...
    for (int i = 0; i < n; i++)
    {   
      pii prevexpanded = {currrange.first - k, currrange.second + k};
      pii common = {max(a[i].first, prevexpanded.first), min(a[i].second, prevexpanded.second)};
