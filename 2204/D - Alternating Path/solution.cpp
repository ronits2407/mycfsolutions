...
 
            ...
            while (!Q.empty())
            {
                ...
                int u = Q.front();
                Q.pop();
                char next = (coloured[u] == 'R') ? 'B' : 'R';
                
 
                for (auto &&neigh : graph[u])
                {
                    if (coloured[neigh] == 'R' && next == 'R')
                    {
                        continue;
                    }
                    else if(coloured[neigh] == 'R' && next == 'B')
                    {
                        bipartitie = false;
                    }
                    else if(coloured[neigh] == 'B' && next == 'R')
                    {
                        bipartitie = false;
                    }
                    else if(coloured[neigh] == 'B' && next == 'B')
                    {
                        continue;
                    }
                    else
