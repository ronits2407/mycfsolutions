...
 
    string prefix = "11110";
    string suffix = "01111";
    string result = prefix + s + suffix;
 
 
 
    for (int i = 5; i < result.length() - suffix.length(); i++)
    {
...
 
        if (result[i] == '0' && result[i-1] == '0' && result[i-2] == '0' && result[i + 1] == '0')
        {
            result[i] = '1';
            count_ones++;
            continue;
...
 
        if (result[i] == '0' && result[i-1] == '0' && result[i-2] == '1' && result[i + 1] == '0' && result[i + 2] == '1')
        {
            result[i] = '1';
            count_ones++;
            continue;
